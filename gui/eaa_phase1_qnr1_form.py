...
class EaaPhase1Qnr1Form(FormBase):
    finished = pyqtSignal(dict)

    def __init__(self, participant_id, marker_streamer: MarkerStreamer):
        super().__init__(name="eaa_p1_qnr1", marker_streamer=marker_streamer)
    ...
    def setupInstructionsLabel(self):
        self.instructionsLabel = QLabel("Please rate the following question on a scale from 1 to 7, where 1 is very unpleasant and 7 is very pleasant.")
    ...
    def setupQuestionnaireGroup(self):
        ...
        self.questions = [
            "How pleasant will it be for you to win the special prize?",
        ]
